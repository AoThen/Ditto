...
type Clip struct {
	...
	UserID         uint      `gorm:"index:idx_clips_user_created;index:idx_clips_user_updated,priority:1;not null" json:"user_id"`
	...
	GroupID        string    `gorm:"size:255;index:idx_clips_group_id" json:"group_id"`
